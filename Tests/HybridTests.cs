...
namespace Framework.Tests
{
    public class Class1 : BaseTest
    {
        ...
        [TestCaseSource(typeof(TestDataProvider), nameof(TestDataProvider.GetData), new object[] { "LoginData2.csv" })]
        public void ValidateloginwithInvalidcredentials(Dictionary<string, string> data)
        {
